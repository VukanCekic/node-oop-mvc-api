...
var user_email_service_1 = __importDefault(require("../../service/user-email.service"));
var EmailerController = /** @class */ (function () {
    function EmailerController() {
        var _this = this;
        this.router = express.Router();
        this.sendEmail = function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var body, emailInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        body = request.body;
                        return [4 /*yield*/, this.userEmailService.sendEmail(body)];
                    case 1:
                        emailInfo = _a.sent();
    ...
    EmailerController.prototype.intializeRoutes = function () {
        /**
         * @swagger
         * /send-email:
         *   post:
